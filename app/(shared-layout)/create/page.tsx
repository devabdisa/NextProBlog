      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="mb-10 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Share your knowledge, tutorials, or thoughts with the NextPro
            community.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-[2fr_1fr] gap-8 items-start">
          <Card className="border-border/50 shadow-xl shadow-primary/5">
            <CardHeader>
              ...
              <CardDescription>
                Fill in the content of your amazing post.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form
                ...
                <Controller
                  ...
                  render={({
                    ...
                    <div className="space-y-4">
                      <div
                        className={`relative border-2 border-dashed rounded-xl p-8 transition-colors text-center ${preview ? "border-primary bg-primary/5" : "border-muted-foreground/25 hover:border-primary/50"}`}
                      >
                        <input
                          type="file"
                          accept="image/*"
            ...
            <Card className="bg-blue-500/10 border-blue-500/20">
              ...
              <CardContent>
                <p className="text-sm text-blue-600/80 dark:text-blue-400/80">
                  Articles with high-quality cover images get 2x more
                  engagement. Make sure your title is catchy and your content
                  provides value!
                </p>
              </CardContent>
            </Card>
